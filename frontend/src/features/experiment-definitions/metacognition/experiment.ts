...
export default {
  id: "metacognition",
  title: "Metacognition",
  description: "Testing prospective and retrospective confidence judgments in a minesweeper task.",
  ...
  nodes: [
    ...
    },
    {
      ...
      config: {
        meta: {
          trial_component: "MetacognitionTrial",
          show_points: false,
          stimuli: {
            source: "../../experiment-definitions/metacognition/stimuli.json",
