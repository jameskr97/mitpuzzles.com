...
const board0Solved: PuzzleState = {
  // @ts-expect-error intentionally partially defined
  definition: def,
  board: [
    [3, 4, 2, 1],
...
<template>
  <FreeplayGameViewInstructionSlider :num_pages="3">
    ...
    <template #page2>
      <div class="flex flex-col gap-2 m-2 h-full text-center">
        <div class="text-xl mb-2">
          Your goal is to <span class="text-red-500">fill in the empty cells</span> with numbers from 1 to 9. Each row,
          column, and 3x3 box must contain <span class="text-red-500"></span> without repetition.
        </div>
