...
/**
 * KakurasuFreeplay - Freeplay mode wrapper for Kakurasu
 *
...
const services = await useFreeplayServices<KakurasuMeta>(puzzle_type);
...
async function request_new_puzzle() {
  ...
  game.value = useKakurasuGame(new_def, null);
