  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive hover:cursor-pointer",
  {
    variants: {
      variant: {
        ...
        blue: "bg-blue-600 text-white shadow-xs hover:bg-blue-700 focus-visible:ring-blue-200 dark:focus-visible:ring-blue-400 dark:bg-blue-700",
        green: "bg-green-600 text-white shadow-xs hover:bg-green-700 focus-visible:ring-green-200 dark:focus-visible:ring-green-400 dark:bg-green-700",
        red: "bg-red-600 text-white shadow-xs hover:bg-red-700 focus-visible:ring-red-200 dark:focus-visible:ring-red-400 dark:bg-red-700",
        purple: "bg-purple-600 text-white shadow-xs hover:bg-purple-700 focus-visible:ring-purple-200 dark:focus-visible:ring-purple-400 dark:bg-purple-700 disabled:bg-purple-600/50",
      },
      size: {
