...
<template>
  <SudokuExperiment />
<!--  <div class="w-full">-->
<!--    <ProgressTimeline class="mx-auto" />-->
...
<!--      <ul class="timeline">-->
<!--        <li>-->
<!--          <div class="timeline-start timeline-box">X</div>-->
...
<!--        <li>-->
<!--          <hr />-->
<!--          <div class="timeline-start timeline-box">Item</div>-->
<!--          <div class="timeline-middle">-->
<!--            <v-icon name="bi-check-circle-fill" scale="1.5" />-->
<!--          </div>-->
<!--          <hr />-->
<!--        </li>-->
<!--        <li>-->
