  ...
  constructor(definition: PuzzleDefinition<T>, board_state?: number[][]) {
    super(
      ...
      [
        ...
        validate_line_all_negative("row", TentsCell.GREEN, "row_tent_counts", [TentCellStates.Tree]),
        validate_line_all_negative("col", TentsCell.GREEN, "col_tent_counts", [TentCellStates.Tree]),
      ],
    );
  }
