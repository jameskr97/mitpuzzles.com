...
import CreateAccountModal from "@/components/ui/modal/account.create.vue";
import LoginModal from "@/components/ui/modal/account.login.vue";
</script>
...
<template>
  ...
  <div class="flex flex-row justify-between gap-2 mt-auto bg-base-200 w-full">
    ...
    <CreateAccountModal id="create_account_modal" />
  </div>
</template>
