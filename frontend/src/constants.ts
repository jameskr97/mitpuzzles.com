...
export const ACTIVE_GAMES: Record<string, ReturnType<typeof create_game_entry>> = {
  ...
  yinyang: create_game_entry("☯️", "yinyang", { admin_only: true }),
  norinori: create_game_entry("🀄", "norinori", { admin_only: true }),
};
...
export const ADMIN_TOOLS: Record<string, ReturnType<typeof create_admin_tool>> = {
  ...
  "news-manager": create_admin_tool("news-manager", "📰", "News Manager"),
};
